...
def check_password_strength(password):
    ...
    if length >= 8 and has_lower and has_upper and has_digit and has_special:
        strength = 'Strong'
    elif length >= 6 and (has_lower + has_upper + has_digit + has_special >= 3):
        strength = 'Medium'
...
# Back Button for Password Generator Frame
# Back Button for Password Generator Frame
btn_back_gen = tk.Button(frame_password_generator, text="Back", font=BUTTON_FONT, bg=BUTTON_BG, fg=BUTTON_FG, command=show_mode_selection, width=10, height=1)
btn_back_gen.pack(pady=10, padx=10, anchor='center')
...
tk.Label(frame_strength_checker, text="Enter Password:", font=BOLD_ITALIC_FONT, bg='#e9ecef').pack(pady=(10, 0))
entry_custom_password = tk.Entry(frame_strength_checker, width=30, font=("Helvetica", 12, "italic"), relief=tk.GROOVE, bd=2)
entry_custom_password.pack(pady=5)

btn_check_strength = tk.Button(frame_strength_checker, text="Check Password Strength", font=BUTTON_FONT, bg=BUTTON_BG, fg=BUTTON_FG, command=check_custom_password)
btn_check_strength.pack(pady=10)

# Label to display password strength in checker
...
# Back Button for Strength Checker Frame
btn_back_check = tk.Button(frame_strength_checker, text="Back", font=BUTTON_FONT, bg=BUTTON_BG, fg=BUTTON_FG, command=show_mode_selection, width=10, height=1)
btn_back_check.pack(pady=10, padx=10, anchor='center')
